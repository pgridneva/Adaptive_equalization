function BER = compBERdopRLS(delay, dopplerShift, EbN0, forgFactor)
...
%data = [SyncSequence, PreambleSequence', trainingSequence', information']';
...
linEq =  comm.LinearEqualizer('Algorithm','RLS', ...
    'NumTaps',5*SPS_eq,'ReferenceTap',refTap,'ForgettingFactor', forgFactor,'InputSamplesPerSymbol',SPS_eq);
